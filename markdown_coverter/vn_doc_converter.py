...
class VietnameseOcrOptions(OcrOptions):
    ...
    lang: List[str] = ["vi"]
    yolo_path: str = os.path.join(folder_weight, "weight/weight_detect_text/weight_detect_text.pt")
    crnn_path: str = os.path.join(folder_weight, "weight/weight_ocr_text/weight_ocr_text.pth")


# ==============================================================================
# CLASS 2: MODEL OCR - TÔN TRỌNG YOLO & GOM KHỐI AN TOÀN (KÈM LỌC NHIỄU)
# ==============================================================================
class VietnameseOcrModel(BaseOcrModel):
    def __init__(self, enabled: bool, options: VietnameseOcrOptions, **kwargs):
        ...
        if self.enabled:
            ...
            # 1. ĐÃ SỬA: Truyền đường dẫn crnn_path vào để không bị lỗi Missing File
